  ...
  <div className="min-h-screen bg-gray-100 p-8">
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow p-12 text-center text-gray-400">
        <p className="text-lg font-medium mb-2">Quote requests coming soon</p>
        <p className="text-sm">Connect a backend to receive and manage quote requests from the contact form.</p>
      </div>
    </div>
  </div>
);
